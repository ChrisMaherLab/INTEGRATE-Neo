...
int usage()
{
    ...
    cerr<<endl;
    cerr<<"Usage:"<<endl;
    cerr<<"fusionBedpeAnnotator --reference-file reference-file --gene-annotation-file annot-file ";
    ...
    cerr<<"    -g/--gene-annotation-file    <string>    [ genePred format annotation                       ]"<<endl;
...
int main(int argc, char * argv[])
{
    ...
    while(1)
    {
        c = getopt_long(argc, argv, "i:o:g:r:h",
    ...
    if (reference_file.compare("")==0 || gene_file.compare("")==0 || output_file.compare("")==0 || input_file.compare("")==0 )
    {
        usage();
        exit(1);    
    }
