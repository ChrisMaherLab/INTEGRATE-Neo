...
def usage():
    ...
    integrate-neo -s <setup.ini> -1 <fastq1> -2 <fastq2> -x <hlaminer-options> -t <hla-allele-tsv> 
                  -f <fusion-bedpe> -r <reference> -g <gene-model> -u <rule-file> 
    ...
    Parameters:
        ...
        -g/--gene-model   [Requested]
                          [string:   GenePhred like 11-column gene model file used by INTEGRATE 0.2.5 and up.]
...
def getParameters(argv):
    try:
        opts, args = getopt.getopt(argv,"h1:2:f:r:g:s:x:t:u:l:a:y:o:k",["help",
                                                          "fastq1=",
                                                          "fastq2=",
                                                          "fusion-bedpe=",
                                                          "reference=",
...
def main(argv):
    ...
    cmd = cur+"/"+"fusionBedpeAnnotator"+" --reference-file "+reference+" --gene-annotation-file "+geneModel \
